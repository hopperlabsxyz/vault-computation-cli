export const LagoonVaultAbi = [
  ...
  {
    inputs: [{ internalType: "uint256", name: "maxRate", type: "uint256" }],
    name: "AboveMaxRate",
    type: "error",
  },
  {
  ...
  {
    inputs: [
      { internalType: "enum State", name: "currentState", type: "uint8" },
    ],
    name: "NotClosing",
    type: "error",
  },
  ...
  {
    inputs: [
      { internalType: "address", name: "_valuationManager", type: "address" },
    ],
  ...
  {
    inputs: [
      { internalType: "address", name: "_whitelistManager", type: "address" },
    ],
