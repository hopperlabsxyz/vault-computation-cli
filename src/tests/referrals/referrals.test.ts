...
// test("check that an offchain rebate doesn't get overriden by an offchain referral", async () => {
//   const address = "0x07ed467acD4ffd13023046968b0859781cb90D9B";
//   const chainId = 1;
//   const fromBlock = 21142252n;
//   const toBlock = 22011758n;
...
//         rewardRateBps: 36,
//         rebateRateBps: 28,
//         referrer: "0x0123456789012345678901234567890123456789",
//         referred: user,
//         vault: "0x0",
//         assets: 0,
//       },
...
//       expect(referralConfig?.referral).toBe(
